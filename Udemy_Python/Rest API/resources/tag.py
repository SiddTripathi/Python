...
class Tag(MethodView):
    ...
    @blp.alt_response(400, description="returned if the tag is assigned to one or more item. Tag cannot be deleted.")
    def delete(self, tag_id):
        ...
        abort(400,message = "Could not delete tags associated with items. Remove item from tags")